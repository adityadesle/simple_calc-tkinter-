# -*- coding: utf-8 -*-
"""
Created on Mon Oct 19 19:41:08 2020
...
button_equal = Button(root,text='=',padx=90,pady=10,command=button_equal)

button_sub = Button(root , text='-',padx=41,pady=10,command=button_sub)
button_mul = Button(root , text='*',padx=41,pady=10,command=button_mul)
button_div = Button(root , text='/',padx=41,pady=10,command=button_div)
